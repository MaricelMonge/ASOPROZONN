<?php $this->Paginator->options(array('update' => '#contenedor-ordens', 'before' => $this->Js->get("#procesando")->effect('fadeIn', array('buffer' => false)), 'complete' => $this->Js->get("#procesando")->effect('fadeOut', array('buffer' => false))));
?>
<?php if(empty($ventas)): ?>
	<font color="green">
			...
			<tbody>
		        <?php foreach($ventas as $orden): ?>
					<tr>
						...
						<td><?php echo h($orden['Cliente']['nombre1']); ?></td>
