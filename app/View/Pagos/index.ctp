<div class="pagos index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('certificacion'); ?></th>
			<th><?php echo $this->Paginator->sort('cuotaMensual'); ?></th>
			<th><?php echo $this->Paginator->sort('interesAcumulado'); ?></th>
			<th><?php echo $this->Paginator->sort('otrosPagos'); ?></th>
			<th><?php echo $this->Paginator->sort('cuota'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($pago['Pago']['cuota']); ?>&nbsp;</td>
